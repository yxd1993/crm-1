...
<%
	...
	String customerInfoPoolId = 
			(request.getParameter("customerInfoPoolId") == null) ? "" : request.getParameter("customerInfoPoolId");
	String obhUserId = (request.getParameter("obhUserId") == null) ? "" : request.getParameter("obhUserId"); 
%>
<script type="text/javascript">
	var cId = '<%= cId%>';
	var customerInfoPoolId = '<%= customerInfoPoolId%>';
	var obhUserId = '<%= obhUserId%>';
</script>
...
<script type="text/javascript" src="${scripts}/AddCustomer/AddCustomer.js"></script>
