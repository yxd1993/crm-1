...
<script type="text/javascript" src="${resource}/ext/build/packages/ext-charts/build/ext-charts.js"></script>
...
<script type="text/javascript" src="${scripts}/authorizationMain/Authorization.js"></script>
</head>
<body>
</body>
</html>