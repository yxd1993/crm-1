...
Ext.define('QuerySqlStore', {
	...
	proxy : {
		type : 'ajax',
		url : '../customer/showPageQuerySql.action',
		actionMethods : 'POST',
		reader : {
			type : 'json',
...
//					Ext.apply(operation,params );
	...
	var grid=Ext.create('Ext.grid.Panel', {
        ...
        tbar:[{
			...
			handler:function(){
				...
				formUrl = '../customer/toVoidQuerySql.action';
	...
	function saveQuerySql(){
	    ...
	    var formUrl = '../customer/saveorModifyQuerySql.action';
